...
print(f"Routing Response 1: {routing_agent.route('Tell me about the history of Rome, Texas')}")
print(f"Routing Response 2: {routing_agent.route('Tell me about the history of Rome, Italy')}")
print(f"Routing Response 3: {routing_agent.route('One story takes 2 days, and there are 20 stories')}")
