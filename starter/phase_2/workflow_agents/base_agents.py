    ...
    def respond(self, input_text):
        ...
        response = client.chat.completions.create(
            ...
            messages=[
                ...
                {"role": "system", "content": self.persona + " Forget all previous context."},
    ...
    def evaluate(self, initial_prompt):
        ...
        for i in range(self.max_interactions): # TODO: 2 - Set loop to iterate up to the maximum number of interactions:
            ...
            if evaluation.lower().startswith("yes"):
                ...
                return { "final_answer": response_from_worker, "number_of_iterations": i + 1 }
            else:
        ...
        return {
            "final_answer": None,
            "number_of_iterations": self.max_interactions + 1  # TODO: 7 - If no solution is found, return None
